...
pub(super) fn knowledge_page_type_literal(value: &crate::store::schema::KnowledgePageType) -> &'static str {
    match value {
        crate::store::schema::KnowledgePageType::ProjectPage => "project_page",
        crate::store::schema::KnowledgePageType::TopicPage => "topic_page",
        crate::store::schema::KnowledgePageType::ClaimPage => "claim_page",
        crate::store::schema::KnowledgePageType::DecisionPage => "decision_page",
        crate::store::schema::KnowledgePageType::PatternPage => "pattern_page",
        crate::store::schema::KnowledgePageType::BreakthroughPage => "breakthrough_page",
        crate::store::schema::KnowledgePageType::ContradictionPage => "contradiction_page",
        crate::store::schema::KnowledgePageType::FrameworkPage => "framework_page",
    }
}

pub(super) fn knowledge_stability_literal(value: &crate::store::schema::KnowledgeStability) -> &'static str {
    match value {
        crate::store::schema::KnowledgeStability::Emerging => "emerging",
        crate::store::schema::KnowledgeStability::Stable => "stable",
        crate::store::schema::KnowledgeStability::Contradicted => "contradicted",
        crate::store::schema::KnowledgeStability::Deprecated => "deprecated",
    }
}
...
pub(super) fn privacy_class_literal(value: &crate::store::schema::PrivacyClass) -> &'static str {
    match value {
        crate::store::schema::PrivacyClass::Public => "public",
        crate::store::schema::PrivacyClass::Project => "project",
        crate::store::schema::PrivacyClass::Personal => "personal",
        crate::store::schema::PrivacyClass::Sensitive => "sensitive",
        crate::store::schema::PrivacyClass::Secret => "secret",
        crate::store::schema::PrivacyClass::Blocked => "blocked",
        crate::store::schema::PrivacyClass::Ephemeral => "ephemeral",
    }
}
