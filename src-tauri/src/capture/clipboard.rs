...
//! copies into the Continuum knowledge graph.
//!
...
/// Fingerprint of the last text Continuum itself wrote to the pasteboard
/// (omnibar "copy again"). The watcher skips it to avoid duplicate nodes.
static LAST_SELF_COPY_FP: AtomicU64 = AtomicU64::new(0);

/// Record that Continuum wrote `text` to the pasteboard so the watcher ignores it.
