...
final class PairingViewModel: ObservableObject {
    ...
    @Published private(set) var stateText: String = "Paste Continuum pairing QR JSON payload"
    ...
    func complete(deviceName: String = "Continuum iPhone", appVersion: String = "0.1.0") {
        isPairing = true
        Task {
