//  Assertions.swift — tiny assertion helpers used by ContinuumKitCheck.
//
...
//  cases in `Tests/ContinuumKitTests/` for Xcode users; both call into the same
//  public surface of ContinuumKit.
